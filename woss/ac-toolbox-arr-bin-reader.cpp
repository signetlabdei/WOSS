...
bool ArrBinResReader::getArrBinHeader() {
  ...
  if(!file_reader) {
      if (woss_ptr->usingDebug()) ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() 
                                              << ")::getBinArrMap() WARNING, can't open " << file_name << ::std::endl;
      return false;
  }
  ...
  if (woss_ptr->usingDebug()) ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getBinArrMap() freq = " << arr_file.frequency << "; Nsd = " << arr_file.Nsd << "; Nrd = " 
  ...
  if (woss_ptr->usingDebug()) {
    for (int i = 0; i < arr_file.Nsd; i++) {
      ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getBinArrMap() Nsd(" << i << ") = " << arr_file.tx_depths[i] << ::std::endl;
    }

    for (int i = 0; i < arr_file.Nrd; i++) {
      ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getBinArrMap() Nrd(" << i << ") = " << arr_file.rx_depths[i] << ::std::endl;
    }

    for (int i = 0; i < arr_file.Nrr; i++) {
      ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getBinArrMap() Nrr(" << i << ") = " << arr_file.rx_ranges[i] << ::std::endl;
    }
  }
...
bool ArrBinResReader::getArrBinFile() {
  ...
  if (woss_ptr->usingDebug()) 
      ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getBinArrMap() skip_header = " 
  ...
  for (int isd = 0; isd < arr_file.Nsd ; isd++) {
    ...
    if (woss_ptr->usingDebug()) 
      ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getBinArrMap() Reading data for source " 
    ...
    for (int ird = 0; ird < arr_file.Nrd; ird++) {
      ...
      for (int irr = 0; irr < arr_file.Nrr; irr++ ) {
        ...
        if ( woss_ptr->usingDebug() ) 
          ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getBinArrMap() curr_arrivals = " 
        ...
        if (curr_arrivals > 0) {
          ...
          for (int i = 0; i < curr_arrivals; i++) {
            ...
            if (woss_ptr->usingDebug()) 
              ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getAsciiArrMap() s_depth = " << arr_file.tx_depths[isd] 
          ...
          if ( woss_ptr->usingDebug() ) 
            ::std::cout << "ArrBinResReader(" << woss_ptr->getWossId() << ")::getAsciiArrMap() no arrivals, inserted zero value"
                        << ::std::endl; 
...
Pressure* ArrBinResReader::readAvgPressure( double tx_depth, double start_rx_depth, double start_rx_range, double end_rx_depth, double end_rx_range ) const {
...
::std::complex<double> ArrBinResReader::readMapAvgPressure( double tx_depth, double start_rx_depth, double start_rx_range, double end_rx_depth, double end_rx_range ) const {

  static double last_tx_depth = ARR_BIN_RES_NOT_SET;
  static double last_start_rx_depth = ARR_BIN_RES_NOT_SET;
  static double last_start_rx_range = ARR_BIN_RES_NOT_SET;
  static double last_end_rx_depth = ARR_BIN_RES_NOT_SET;
  static double last_end_rx_range = ARR_BIN_RES_NOT_SET;
